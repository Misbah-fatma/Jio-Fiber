...
function Card() {
  return (
    <div className="card flex flex-col items-center justify-center gap-5  rounded-3xl p-20">
      <img src="/airfiber-icon.svg" alt="" />
      <p className="text-white font-black text-4xl">
        JioAirFiber is now available in 514<p style={{textAlign : 'center'}}>towns</p>
      </p>
      ...
      <img src="/ribbon-arifiber.png" alt="" className ="image"/>
    </div>
  );
}
